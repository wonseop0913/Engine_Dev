...
class BULB_API EditorGUIManager
{
	friend class BulbApplication;
	friend class RenderManager;

private:
	EditorGUIManager() = default;
	~EditorGUIManager();
...
public:
	EditorGUIManager(const EditorGUIManager& rhs) = delete;
	EditorGUIManager& operator=(const EditorGUIManager& rhs) = delete;
